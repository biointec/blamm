# From Radu Serban
# http://www.mail-archive.com/cmake@cmake.org/msg04695.html
...
#  "SET_TARGET_PROPERTIES(flib PROPERTIES LINK_FLAGS \"-b64\")\n"
  "ADD_LIBRARY(flib ftest.f90)\n"
  )

# Create a simple Fortran source which defines two subroutines, "mysub" and "my_sub"
FILE(WRITE ${PROJECT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/ftest.f90
  "        SUBROUTINE mysub\n"
  "   3     RETURN\n"
  "        END\n"
  "        SUBROUTINE my_sub\n"
...
IF( NOT FTEST_OK)
  ...
  MESSAGE(FATAL_ERROR 
    ...
    "Problem to build flib in FortranScheme.cmake (STEP 1)\n"
    " Check options of your compilor to compile ftest.f90 file\n"
    "   or check options to build flib library.\n"
    "_________________________________________________\n")
ELSE ( NOT FTEST_OK)
  MESSAGE(STATUS "COMPILE to make the target lib OK (FORTRAN)")
ENDIF( NOT FTEST_OK)
...
SET(options mysub mysub_ mysusb__ MYSUB MYSUB_ MYSUB__)
...
#    MESSAGE("  ---> ERROR COMPILE")
  ...
  ENDIF(CTEST_OK)
#MESSAGE("SCHEME_NO_UNDERSCORES:   ${SCHEME_NO_UNDERSCORES}")
...
ELSEIF(SCHEME_NO_UNDERSCORES)
    SET(SCHEME_WITH_UNDERSCORES "To be defined" 
      CACHE INTERNAL "Name mangling scheme (symbol names with underscores)")
  mark_as_advanced(FORTRAN_C_DEFINE_F77_FUNC "${CPP_macro}")
  MESSAGE("Unable to determine name mangling scheme for symbol names without  underscores!")
  MESSAGE(FATAL_ERROR "You must specify CPP _Macro and  DEFINE_F77_FUNC by hand:\n"
    " exemple: #define F77_FUNC(name,NAME) NAME ## _\n"
    "SET(CPP_macro \"#define F77_FUNC(name,NAME) NAME ## __\")\n")  
ENDIF(SCHEME_NO_UNDERSCORES)

SET(DEFINE_F77_FUNC "${CPP_macro}"
  CACHE STRING "CPP macro for name mangling scheme of symbols without underscores")
...
#  MESSAGE("Unable to determine name mangling scheme for symbol names without 
#underscores!")
#ENDIF(SCHEME_NO_UNDERSCORES)
...
#  MESSAGE("Unable to determine name mangling scheme for symbol names with 
#underscores!")
#ENDIF(SCHEME_WITH_UNDERSCORES)
